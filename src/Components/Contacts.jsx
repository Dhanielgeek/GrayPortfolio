...
const Contacts = () => {
  return (
    <div className='bg-[#080f23] w-full h-screen  flex justify-center items-center p-4' name= "Contacts">
        <form method='POST' action='https://getform.io/f/69b1e0b6-00d7-4375-b491-1b48b17c4e0d' className='flex flex-col w-full max-w-[600px]'>
            <div className='pb-8'>
                <p className='text-4xl font-bold border-b-4 border-gray-300 inline text-gray-300'>Contacts</p>
                <p className='py-4 text-gray-300'>Submit this Form or Send me a direct Email : <a className=' text-red-400' href='Ekelegrace.ge@gmail.com'>Ekelegrace.ge@gmail.com</a>  </p>
            </div>
