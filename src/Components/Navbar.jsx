...
<div className=' hidden xl:flex fixed flex-col top-[35%] left-0'>
  <ul>
    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#0072b1] rounded-lg'> 
      <a  className='flex justify-between items-center w-full text-gray-200' href='https://www.linkedin.com/in/grace-ekele-76223723a'>Linkedin <FaLinkedin size={30}/>
      </a>
    </li>
    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#171515] rounded-lg'>
    <a className='flex justify-between items-center w-full text-gray-300' href='https://github.com/Grace-ekele'>Github <FaGithub size={30} /> </a>
    </li>
    ...
    <a className='flex justify-between items-center w-full text-gray-300' href='Ekelegrace.ge@gmail.com'>Gmail <HiOutlineMail size={30}/> </a>
    </li>
    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#51d968] rounded-lg'>
    <a className='flex justify-between items-center w-full text-gray-100' href='https://drive.google.com/file/d/https://drive.google.com/file/d/1J9BTtXHbwRWQ1BenwMwCCiUuSsfR2ueg/view-ApphAKq3R8rdwEhBzu-aKb/view?usp=share_link'>Resume <BsPersonDashFill size={30}/> </a>
    </li>
  </ul>
</div>
    </div>
